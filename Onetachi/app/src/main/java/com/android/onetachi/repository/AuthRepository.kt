...
package com.android.onetachi.repository
...
import com.android.onetachi.api.Credential
...
class AuthRepository(
     ...
     */
    fun registerRequest(processing: MutableLiveData<Boolean>,
                        id: String, username: String, idPart1: String, idPart2: String): LiveData<Fido2PendingIntent> {
